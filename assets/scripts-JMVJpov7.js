import{h as b,i as a,k as S,l as t}from"./index-DZKib4c0.js";const f=(n={})=>{const e=n.databaseEdition,E=`
...
) AS metadata_json_to_import;`,H=(n={})=>n.databaseEdition===a.SQL_SERVER_2016_AND_BELOW?U:h,F='""',x=`SET SESSION group_concat_max_len = 10000000;
SELECT CAST(CONCAT(
    '{"fk_info": [',
    IFNULL((SELECT GROUP_CONCAT(
        CONCAT('{"schema":"', cast(fk.table_schema as CHAR),
...
WITH fk_info AS (
	...
	FROM   dual
`,G={[t.GENERIC]:()=>"",[t.POSTGRESQL]:f,[t.MYSQL]:I,[t.SQLITE]:g,[t.SQL_SERVER]:H,[t.MARIADB]:()=>x,[t.CLICKHOUSE]:()=>D,[t.COCKROACHDB]:()=>B,[t.ORACLE]:()=>w};export{G as importMetadataScripts};
